...
- After a real Even by Item rebalance (seven completed item plans), checked all 37 non-unified inventory-owner bounds: no overlap. Native owner heights are retained and content-size changes recalculate the list. Turning both unified columns off and re-enabling also worked.
