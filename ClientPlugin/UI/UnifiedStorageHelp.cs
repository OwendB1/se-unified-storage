...
internal static class UnifiedStorageHelp
{
    public static string Screen(string caption) => Wrap(caption switch
    {
        ...
        "Edit inventory group" => "Combine a block selector, inventory role and item filters. Apply saves the view; Cancel discards edits. Saved terminal-group names include future matching blocks automatically.",
    ...
    public static string Button(string caption, string text) => Wrap((caption, text) switch
    {
        ...
        ("Edit inventory group", "Apply") => "Save this group's name, live block selector and item filters, then close. This changes a view; it does not move items.",
